...
/**
 * This endpoint handles holiday requests. It uses a combination of JDOM and
 * XPath to extract interesting pieces of XML from the incoming message, and
 * invoked the injected {@link HumanResourceService} with those.
 * 
...
public class HolidayEndpoint {
	...
	public void handleHolidayRequest(@RequestPayload Element holidayRequest)
		...
		String name = firstNameExpression.evaluateFirst(holidayRequest)
				.getText()
				+ " "
